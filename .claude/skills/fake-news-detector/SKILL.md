...
2. Run detection passes, starting with the factual red-flag pass in `references/factual-red-flags.md`, then the bias & framing pass in `references/bias-framing.md`. **Placeholder:** remaining detection dimensions for logical fallacies, clickbait and hype, and narrative manipulation will be added in later issues (#8-#10) through `references/`.
